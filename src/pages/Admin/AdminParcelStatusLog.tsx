...
const AdminParcelStatusLog = ({ parcelId }: { parcelId: string }) => {
    const { data: parcelStatusData, isLoading } = useGetParcelStatusQuery(parcelId, { skip: !parcelId })
...
export default AdminParcelStatusLog;